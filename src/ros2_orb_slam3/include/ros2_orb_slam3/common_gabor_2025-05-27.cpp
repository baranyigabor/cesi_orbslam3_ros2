...
{   
    ...
    private:
        ...
        std::string pubodometryMsgName = "";
        std::string cameraInfoMsgName = "";
        std::string cameraImageMsgName = "";
        std::string cameraDepthImageMsgName = "";
        std::string subBundleAdjustmentMsgName = "";
        ...
        rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr odometry_data_publisher_;
        rclcpp::Publisher<sensor_msgs::msg::CameraInfo>::SharedPtr camera_info_publisher_;
        rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr camera_image_publisher_;
        rclcpp::Publisher<sensor_msgs::msg::Image>::SharedPtr camera_depth_image_publisher_;
        ...
        rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr subBundleAdjustmentMsg_subscription_;
        ...
        void Depth_Img_callback(const sensor_msgs::msg::Image& msg); // Callback to process Depth image
        void TriggerRefinement(const std_msgs::msg::Bool::SharedPtr msg); //Callback to trigger Bundle Adjustment
        ...
        void RGBD_Img_callback(const sensor_msgs::msg::Image::ConstSharedPtr& rgb_msg,
                               const sensor_msgs::msg::Image::ConstSharedPtr& depth_msg);
     
        //std::unique_ptr<ORB_SLAM3::System> SLAM;
     
        // Message filters for RGB & Depth synchronization
        message_filters::Subscriber<sensor_msgs::msg::Image> rgb_sub_;
        message_filters::Subscriber<sensor_msgs::msg::Image> depth_sub_;
     
        // Synchronizer for RGB & Depth
